...
export const leyteFleets = [
  ...
  // '瑞鶴', '千代田', '千歳', '瑞鳳', '伊勢', '日向', '多摩', '五十鈴', '大淀', '初月', '若月', '秋月',  '霜月'
  {
    ...
    ships: [111, 103, 102, 116, 77, 87, 100, 22, 183, 357, 330],
  },
  // 愛宕、高雄、摩耶、鳥海
  // 大和、武蔵、長門
  // 妙高、羽黒
  ...
  // '愛宕', '高雄', '摩耶', '鳥海', '大和', '武蔵', '長門', '妙高', '羽黒', '能代','島風', '早霜', '秋霜', '岸波', '沖波', '朝霜', '長波', '浜波', '藤波'
  {
    ...
    ships: [67, 66, 68, 69, 131, 143, 80, 62, 65, 138, 50, 324, 359, 344, 135, 373],
  },
  // 金剛、榛名
  // 鈴谷、熊野、利根、筑摩
  ...
  // '金剛', '榛名', '鈴谷', '熊野', '利根', '筑摩', '矢矧', '浦風', '磯風', '雪風', '浜風', '清霜', '野分'
  {
    ...
    ships: [78, 79, 124, 125, 71, 72, 139, 168, 167, 20, 170, 325, 329],
  },
  // 山城、扶桑
  // 最上
  // 時雨
  ...
  // '那智', '足柄', '阿武隈', '曙', '潮', '霞', '不知火', '若葉', '初春', '初霜', '青葉', '鬼怒', '浦波'
  {
    ...
    ships: [63, 64, 114, 15, 16, 49, 18, 40, 38, 41, 61, 113, 368],
  },
  // Iowa
  // 'Iowa'
  {
